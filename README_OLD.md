...
[Features](#-features) • [Architecture](#-system-architecture) • [Installation](#-installation) • [API Docs](#-api-documentation) • [Database](#-database-schema)
...
**CodeGuard Nexus** is a professional-grade plagiarism detection and code similarity analysis platform built for academic institutions. Leveraging advanced algorithms, machine learning, and network graph analysis, it provides educators with comprehensive insights into code submissions, collaboration patterns, and academic integrity violations.

### Key Capabilities

- 🔍 **Multi-Algorithm Detection**: Combines AST analysis, token-based comparison, and ML models
- 🤖 **AI-Generated Code Detection**: Identifies ChatGPT, Copilot, and other LLM-generated code
- 📊 **Network Visualization**: Interactive D3.js graphs showing collaboration patterns
- ⚡ **High Performance**: Process 1000+ submissions with O(n²) optimization
- 🔐 **Enterprise Security**: Supabase backend with RLS, JWT authentication
